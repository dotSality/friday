...
export const CustomMuiSelect: FC<PropsType> = React.memo(({value, onChangeOptions}) => {

        const handleChange = (e: SelectChangeEvent) => onChangeOptions(Number(e.target.value))
